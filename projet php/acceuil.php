...
<header class="speedyui speedyui-header">
            ...
            <div class="row">
                <div class="col-auto col-lg-4">
                    <span class="d-none d-lg-flex align-items-center gap-2">
                        ...
                        <a class="nav-link text-uppercase" href="#">1 855 588 2436 </a>
                    </span>
                </div>
    ...
    <nav class="bg-light navbar navbar-expand-lg py-2 py-md-0">
        <div class="container py-2 py-lg-0">
            ...
            <a class="navbar-brand" href="#">
                <img class="img-fluid" src="https://s3.amazonaws.com/speedyui-static/navbar-horizontal/logo.png" alt="" />
            </a>
