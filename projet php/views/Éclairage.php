...
<body>
    ...
    <main class="container">
        ...
        <?php
        $sql = "SELECT ID_produit,nom,PRIX,Sourceimg,Descrition FROM Produits where typeProduit ='Éclairage' ";
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
                <div class="card d-inline-block m-5" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="../Controllers/panier.php?redirect=Éclairage.php" style="display:inline;">
