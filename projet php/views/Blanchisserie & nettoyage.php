...
<head>
    ...
    <title>Blanchisserie & nettoyage</title>
...
<body>
    ...
    <main class="container">
        <h1 class="text-dark display-0 text-center mt-2">Blanchisserie & nettoyage</h1>
        <br>
        <div>
        ...
        <?php
        $sql = "SELECT ID_produit,nom,PRIX,Sourceimg,Descrition FROM Produits where typeProduit ='Blanchisserie' ";
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
                <div class="card d-inline-block m-5" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                        $param = "Blanchisserie & nettoyage.php";
                        ?>
