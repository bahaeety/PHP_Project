...
<body>
    ...
    <main class="container">
        <h1 class="text-dark display-0 text-center mt-2">Tous les meubles</h1>
        <br>
        <div>
        ...
        <?php
        $sql = "SELECT ID_produit,nom,PRIX,Sourceimg,Descrition FROM Produits ";
