...
<head>
    ...
    <title>Produits pour animaux de compagnie</title>
...
<body>
    ...
    <main class="container">
        <h1 class="text-dark display-0 text-center mt-2">Produits pour animaux de compagnie</h1>
        <br>
        <div>
        ...
        <?php
        $sql = "SELECT ID_produit,nom,PRIX,Sourceimg,Descrition FROM Produits where typeProduit ='Produitspouranimauxdecompagnie' ";
            ...
            while ($row = mysqli_fetch_assoc($result)) { ?>
                <div class="card d-inline-block m-5" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <?php
                        $param = "Produits pour animaux de compagnie.php"
                        ?>
                        <form method="post" action="../Controllers/panier.php?redirect=<?=urlencode($param)?>" style="display:inline;">
